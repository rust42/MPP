...
public class Main {
	public static void main(String[] args) {
		...
		public static void prob1() {
			...
			System.out.println(LambdaLibrary.EMPLOYEE_SALARIES.apply(list, 55000, 120000));
		...
		public static void prob2() {
			...
			System.out.println(LambdaLibrary.TRANSACTION_FILTER.apply(list, 2011));
		}
		// Create a Lambda Library entry that does the following:
		...
		public static void prob3() {
			//Use this list
			List<Transaction> list = TraderTransactTestData.getTransactions();  
			System.out.println(LambdaLibrary.TRADER_CITY_FILTER.apply(list, "Cambridge"));
