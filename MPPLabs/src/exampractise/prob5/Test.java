...
//		 uncomment when ready
		 List<Pair<String, String>> pairList = AllPairs.allIncreasingPairs1(strs);
		 System.out.println(pairList);
	...
	public static void testLocalDates() {
		 ...
		 //uncomment when ready
		 List<Pair<LocalDate, LocalDate>> pairList = AllPairs.allIncreasingPairs1(dates);
		 System.out.println(pairList);
	...
	public static void testEmployees() {		
		...
		List<Pair<Employee, Employee>> pairList = AllPairs.allIncreasingPairs1(emps);
		System.out.println(pairList);
