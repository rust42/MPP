package exercises.lesson9.exercise_3;
import lesson9.collect.Employee;
...
public class Main {
	...
	public static void main(String[] args) {
		...
		//sorting code here
		Comparator<Account> comparator = Comparator.comparing((Account a) -> a.getBalance())
				.thenComparing(a -> a.getOwnerName());
		System.out.println(accounts.stream().sorted(comparator).collect(Collectors.toList()));
